            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-header bg-white py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 fw-bold">Edit Surat Keluar</h5>
                            <small class="text-muted">Perbarui informasi data surat keluar</small>
                        </div>
                    </div>
                </div>

                <form action="{{ route('transaction.outgoing.update', $data) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-footer bg-light d-flex justify-content-between align-items-center py-3">
                        <a href="{{ route('transaction.outgoing.index') }}" class="btn btn-label-secondary">
