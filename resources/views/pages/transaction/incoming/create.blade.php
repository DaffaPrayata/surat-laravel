...
<div class="sm-wrap">
    ...
    <div class="sm-header">
        ...
        <h1 class="sm-title">Input Surat Masuk</h1>
        <p class="sm-subtitle">Isi seluruh kolom sesuai data surat yang diterima.</p>
    </div>
        ...
        <form action="{{ route('transaction.incoming.store') }}" method="POST">
            ...
            <div class="sm-section">
                ...
                <div class="sm-grid">
                    ...
                    {{-- PENGIRIM --}}
                    <div class="sm-field full">
                        <label class="sm-label" for="from">
                            {{ __('model.letter.from') }} <span class="req">*</span>
                        </label>
                        <input
                            id="from"
                            type="text"
                            name="from"
                            class="sm-input @error('from') is-invalid @enderror"
                            value="{{ old('from') }}"
                            placeholder="Nama Siswa/Guru/Instansi Pengirim"
                            required
                        >
                        @error('from')
                            <span class="sm-error-text">{{ $message }}</span>
            ...
            <div class="sm-section">
                ...
                <div class="sm-grid">
                    ...
                    {{-- TANGGAL DITERIMA --}}
                    <div class="sm-field">
                        <label class="sm-label" for="received_date">
                            {{ __('model.letter.received_date') }} <span class="req">*</span>
                        </label>
                        <input
                            id="received_date"
                            type="date"
                            name="received_date"
                            class="sm-input @error('received_date') is-invalid @enderror"
